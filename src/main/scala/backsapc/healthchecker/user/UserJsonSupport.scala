...
import backsapc.healthchecker.user.Contracts.TokenServiceOperationResults.WrongPasswordError
...
trait UserJsonSupport extends JsonSupport {
  ...
  implicit val confirmationErrorJsonFormat = jsonFormat1(ConfirmationError)
