package org.backsapce.healthchecker.api
...
/**
  * The HealthChecker service interface.
  * <p>
  * This describes everything that Lagom needs to know about how to serve and
  * consume the HealthcheckerService.
  */
trait HealthcheckerService extends Service {
  ...
  override final def descriptor: Descriptor = {
    ...
    named("healthchecker")
      ...
      .withTopics(
        topic(HealthcheckerService.TOPIC_NAME, greetingsTopic _)
